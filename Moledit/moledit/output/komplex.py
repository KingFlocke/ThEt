...
komplex_box_vtk = LegacyVTKReader(FileNames=['komplex_box.vtk'], guiName = "komplex_box")
DataRepresentation1 = Show()

komplex_comp1_vtk = LegacyVTKReader(FileNames=['komplex_comp1.vtk'], guiName = "komplex_comp1")
DataRepresentation2 = Show()

komplex_comp2_vtk = LegacyVTKReader(FileNames=['komplex_comp2.vtk'], guiName = "komplex_comp2")
DataRepresentation3 = Show()

SetActiveSource(komplex_comp1_vtk)
...
SetActiveSource(komplex_comp2_vtk)
